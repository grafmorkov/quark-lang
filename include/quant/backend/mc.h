...
// executable flavor (see targets.h, AArch64ISel, elf/pe writers).
...
// An (architecture, OS) pair identifying one compilation target.
// See targets.h for the registry of known/enabled targets.
struct Target {
